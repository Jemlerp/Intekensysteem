...
namespace AdminGUI
{
    public partial class FormGetSerialPort : Form
    {
        public FormGetSerialPort()
        {
            InitializeComponent();
        }
        ...
        {
            if (FormHelp.testSerialPort((string)listBox1.SelectedItem))
            {
                button1.BackColor = Color.Green;
                GotWorkingPort = true;
                Port = (string)listBox1.SelectedItem;
            }
            else
            {
